...
const OPENING_PHRASES = [
  ...
  'The amazing and powerful Joe says:',
  "Not everyone can be Joe, but if they were they'd be rich. Here's what Joe would say:",
  ...
  "If Joe were making the call:",
  "Wearing my best Joe impression:",
  'According to the Joe playbook:',
  "If Joe had five minutes, here's what he'd say:",
  'In true Joe fashion:',
  'The Joe-approved move here:',
  "Joe's instinct on this:",
  "If you asked Joe over coffee, he'd say:",
  'In the Joe-verse, the obvious move:',
  'Joe would cut through the noise and say:',
  'From a very Joe point of view,',
  'If Joe were optimizing for results:',
  "Joe's short answer:",
  'The Joe way to think about this:',
  'As a follower of Joe:',
  "Some people say Joe isn't God. They are wrong. Here's what he'd say:",
  "Joe's take?",
